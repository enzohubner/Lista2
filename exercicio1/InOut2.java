...
public class InOut2 {
     ...
     * 
     * @param string que ser? usada para o usu?rio saber qual dado ser? lido
     * @return um objeto do tipo int
     */
    public static int leInteger(String string) {
        int num = 0;
        String Entrada;
        boolean ERRO;
        ...
        do {
            try {
                Entrada = JOptionPane.showInputDialog(null, string, "Entrada de dados",
                        JOptionPane.QUESTION_MESSAGE);
    ...
    public static Integer leInt(Integer idade) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'leInt'");
    }
}